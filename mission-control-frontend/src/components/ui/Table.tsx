...
>(({ className, ...props }, ref) => (
    <tr
        ref={ref}
        className={cn(
            "border-b border-border transition-colors hover:bg-backgroundGray/30 data-[state=selected]:bg-neutral-100 dark:hover:bg-backgroundGray/30 dark:data-[state=selected]:bg-neutral-800",
            className
        )}
        {...props}
    />
